		...
		"sections"   => [
			[
				...
				'fields' => [
					...
					[
						'id'       => 'document_theme_bg_color',
						'title'    => '全局背景颜色',
						'callback' => 'nicen_theme_form_color',
					],
					[
						'id'       => 'document_theme_Gutenberg',
						'title'    => '禁用古腾堡编辑器',
					...
					[
						...
						'args'     => [
							...
							'tip'     => '插件元标签模式识别[h1][h2][h3]、HTML标签模式识别&lt;h2&gt;&lt;h3&gt;&lt;h4&gt'
						]
					],
					[
...
define( "CONFIG", [
	...
	//栏目文章导航
	"document_theme_bg_color"           => "#f2f3f5",
	"document_theme_Gutenberg"          => 0,
